...
unsigned int GasTimePre;//all times in milliseconds
unsigned int GasTimePost;
unsigned int FeedTime;
unsigned int PowerTime;
unsigned long CurrentMillis;
//wont need gasonmillis as this would be turned on at the start of the button press regardless
unsigned long GasOffMillis;
//wont need feedonmillis as feed and power turn on at the same time
